                        ...
                        <div class="col">
                            <div class="card h-100 shadow-sm border-0 rounded-4 medicineCard">
                                <div class="card-body" style="max-height: 180px; overflow-y: auto;">
                                    <img src="static/media/images/paracetamol.jpg" class="card-img-top p-3 denominationImage" alt="Medicine Image" style="border-radius: 20px;" id="dummyMedicineImage">
