...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<c:url value='/static/css/viewPatientAppointmentPage.css' />"
    />
  </head>
  ...
  <body>
    ...
    <div class="appointment-container">
      <div class="appointment-header">
        <h4><i class="bi bi-journals me-2"></i></i>Your Appointments</h4>
      </div>
      <div class="showAppointmentDiv" id="showAppointmentDiv">
        <div class="findAppointmentPanel d-flex" id="findAppointmentPanel">
          <div>
            <input
              type="text"
              name="searchAppointmentInput"
              id="searchAppointmentInput"
              class="searchAppointmentInput"
              placeholder="Search here..."
            />
          </div>
          <div class="d-flex searchAppointmentInputInfo">
            <i class="bi bi-info-circle px-1"></i><p>Search Your Appointment!</p>
          </div>
        </div>
        <div class="appointmentsCardParentDiv" id="appointmentsCardParentDiv"></div>
      </div>
    </div>
    <!--Store End-->
    <!-----------------Store End----------->
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="static/js/viewPatientAppointmentPage.js"></script>
  </body>
</html>
