    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (medicine.addMedicine()) {
            ...
            new UserNotification("Medicine " + medicine.getName() + " is added in the Store!", user).addNotification();
             response.getWriter().write("Medicine Added successfully");

            // if (medicine.collectMedicines(medicine.getMedicineId())) {
            // System.out.println("Medicines Collected");
            // }
            GenericMedicine genericMedicine = new GenericMedicine();
            genericMedicine.setGenericMedicineId(genericMedicineId);
            // MedicineComposition medicineComposition = new MedicineComposition(medicine,
            // genericMedicine);
