...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<c:url value='/static/css/patientPrescription.css' />"
    />
  </head>
  ...
  <body>
    ...
    <div class="prescription-container">
      <div class="prescription-header">
        <h4><i class="bi bi-journals me-2"></i></i>Your Prescription</h4>
      </div>
      <div class="showPrescriptionDiv" id="showPrescriptionDiv">
          <div class="prescriptionCardParentDiv" id="prescriptionCardParentDiv"></div>
        </div>
      </div>
    </div>
    <!--Store End-->
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="static/js/patientPrescription.js"></script>
  </body>
</html>
