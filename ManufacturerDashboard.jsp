...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<c:url value='/static/css/ManufacturerDashboard.css' />"
    />
  </head>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="MedicineStore.do"
                >Your Store</a
              >
            </li>
        ...
        <div class="modal-content manufacturer-modal-custom">
          <div class="modal-header manufacturer-header-custom">
            ...
            <button
              ...
              aria-label="Close"
            >
              <i class="bi bi-x-lg" style="color: white; font-weight: bold"></i>
            </button>
          </div>
          <div class="modal-body manufacturer-body-custom">
            <form
              action="configureManufacturer.do"
              method="post"
              id="configureManufacturerForm"
            >
              <div class="form-floating mb-3 manufacturer-field-group">
                <div class="manufacturer-label-wrapper">
                  ...
                  <p class="manufacturer-label-text">
                    Company Name<span class="manufacturer-required-star"
                      >*</span
                    >
                  </p>
                </div>
              ...
              <div class="form-floating mb-3 manufacturer-field-group">
                <div class="manufacturer-label-wrapper">
                  ...
                  <p class="manufacturer-label-text">
                    Company Email<span class="manufacturer-required-star"
                      >*</span
                    >
                  </p>
                </div>
                ...
                <div class="manufacturer-helper-text">
                  <i class="fas fa-info-circle manufacturer-helper-icon"></i>
                  <span
                    >Official email address for business communications</span
                  >
                </div>
              </div>
              ...
              <div class="modal-footer manufacturer-footer-custom">
                <button
                  type="submit"
                  class="btn btn-primary manufacturer-submit-custom"
                >
          ...
          <div class="modal-body p-4">
            ...
            >
                ...
                <div class="row g-3 mb-3">
                  <div class="col-md-6">
                    <div class="icon-wrapper">
                      ...
                      <div class="form-floating">
                        <select
                          name="genericMedicineType"
                          id="genericMedicineType"
                          class="form-select"
                        >
                          <option value="0" disabled>Select</option>
                          <c:forEach
                            var="genericMedicine"
                            items="${applicationScope.genericMedicine}"
                            varStatus="status"
                          >
                            <option value="${status.index + 1}">
                              ${genericMedicine.name}
                            </option>
                          </c:forEach>
                        </select>
                        <label for="genericMedicineType"
                          >Generic Medicine</label
                        >
                      </div>
                    </div>
                  </div>
              ...
              <div class="modal-footer border-0">
                <button
                  ...
                  data-bs-dismiss="modal"
                  id="addMedicineCloseBtn"
                >
                  <i class="bi bi-x-circle"></i>
                  Close
                </button>
                <button type="button" class="btn" id="addMedicineSubmitBtn">
            ...
            >
              <div class="col-md-12 addDenominationDiv" style="display: none">
                ...
                <input
                  type="number"
                  name="noOfDenomination"
                  id="noOfDenomination"
                  required
                  placeholder="Enter No. of Denomination"
                ...
                <button
                  type="button"
                  class="btn mb-3"
                  id="generateInputForDenomination"
                >
