...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<c:url value='/static/css/medicineMarketForDoctor.css' />"
    />
  </head>
  ...
  <body>
    ...
    <div class="store-container">
        <div class="store-header">
            <h4><i class="bi bi-shop"></i> Medicine Market</h4>
        </div>
...
<div class="modal fade " id="confirmingMedicineRemovalModal" tabindex="-1" aria-labelledby="confirmingMedicineRemovalModal" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="static/js/medicineMarketForDoctor.js"></script>
  </body>
</html>
